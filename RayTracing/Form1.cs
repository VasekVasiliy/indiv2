...
namespace RayTracing
{
    public partial class Form1 : Form
    {
        ...
        public void build_scene()
        {
            ...
            room.sides[0].drawing_pen = new Pen(Color.Orange);
            ...
            room.sides[2].drawing_pen = new Pen(Color.Pink);
            ...
            Sphere s1 = new Sphere(new Point3D(-2.8f, -2.5f, 0f), 2f);
            s1.set_pen(new Pen(Color.Gray));
            ...
            cube2.set_pen(new Pen(Color.Green));
            ...
            Sphere s2 = new Sphere(new Point3D(1f, 3f, -3f), 1.7f);
